      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-12 w-full px-5 md:col-span-9">
          <div className="flex w-full items-center justify-between py-6">
            <div className="flex items-center">
              ...
              <div className="text-white">
                <div className="bg-neutral col-span-8 h-6 w-64 animate-pulse rounded-md "></div>
                <div className="flex gap-4">
                  <div className="bg-neutral col-span-8 mt-3 h-4 w-20 animate-pulse rounded-md "></div>
                  <div></div>
                </div>
              </div>
            </div>
          ...
          <div className="my-5 flex select-none items-center justify-start gap-5">
            <div className="bg-neutral col-span-8 mt-3 h-1 w-14 animate-pulse rounded-md "></div>
            <div className="bg-neutral col-span-8 mt-3 h-1 w-14 animate-pulse rounded-md "></div>
            <div className="bg-neutral col-span-8 mt-3 h-1 w-14 animate-pulse rounded-md "></div>
          </div>
        </div>
        ...
        <div className="col-span-3 hidden rounded-2xl border-[1px] border-primary md:block">
          {arr.map((item) => (
            <div key={item} className="flex items-center gap-2 p-3">
              <div className="bg-neutral col-span-8 h-10 w-10 animate-pulse rounded-full"></div>
              <div className="text-white">
                <div className="bg-neutral col-span-8 h-4 w-44 animate-pulse rounded-md "></div>
                <div className="flex gap-4">
                  <div></div>
                </div>
              </div>
          ...
          <div className="h-auto w-full rounded-2xl border-[1px] border-primary pb-3">
            {arr.map((item) => (
              <div className="grid grid-cols-12 gap-2 p-3 py-2" key={item}>
                <div className="bg-neutral col-span-1 h-12 w-full animate-pulse rounded-md"></div>
                <div className="bg-neutral col-span-8 h-12 w-full animate-pulse rounded-md "></div>
                <div className="bg-neutral col-span-2 h-12 w-full animate-pulse rounded-md"></div>
                <div className="col-span-1 flex h-12 w-full animate-pulse items-center justify-center">
                  <BiStar className="text-neutral text-xl" />
                </div>
              </div>
            ))}
          </div>
